...
import 'main.dart';
import 'config.dart';
/// A screen for user authentication, allowing users to log in with their email
/// and password, or navigate to registration and password reset flows.
class LoginScreen extends StatefulWidget {
  const LoginScreen({super.key});

  /// A globally accessible static variable holding the logged-in user's email.
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  /// Authenticates the user against the backend server.
  /// Validates inputs, sends a POST request, and upon success, updates global
  /// state and navigates to the [HomeScreen].
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: isLoading ? null : () {
                    if (isForgotPasswordMode) {
                      debugPrint("Reset Link Logic Here");
                    } else {
                      loginUser();
                    }
                  },
  ...
  /// Builds a customized text input field, handling optional password obfuscation.
  ...
  /// Builds a stylized container for a social login icon.
