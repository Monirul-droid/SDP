...
import 'dart:convert';
import 'login_screen.dart'; // Email access করার জন্য
...
class _DetailScreenState extends State<DetailScreen> {
  ...
  Future<void> _checkIfFavorite() async {
    ...
    final url = Uri.parse("http://192.168.0.106:5000/check_favourite/$email/$name");
  ...
  Future<void> _addFavorite() async {
    final url = Uri.parse("http://192.168.0.106:5000/add_favourite");
    try {
  ...
  Future<void> _removeFavorite() async {
    ...
    final url = Uri.parse("http://192.168.0.106:5000/delete_favourite/$favoriteId");
    try {
  ...
  // ✅ Description text-এর ভেতরে Estimated Value bold করার helper function
