...
class _TourPackageScreenState extends State<TourPackageScreen> {
  ...
  Future<void> fetchPackages() async {
    final url = Uri.parse("http://192.168.0.106:5000/get_all_packages");
    try {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Exclusive Tour Packages", style: TextStyle(color: Colors.white)),
          ...
          return Card(
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  height: 160, // Height ektu bariyechi chobir jonno
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          Text(item['city'], style: const TextStyle(fontSize: 22, fontWeight: FontWeight.bold)),
                          Container(
                            padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 5),
                            decoration: BoxDecoration(color: Colors.green[100], borderRadius: BorderRadius.circular(10)),
                            child: Text(item['budget'], style: const TextStyle(color: Colors.green, fontWeight: FontWeight.bold)),
                          ),
                        ],
                      ),
                      ...
                      if (isExpanded) ...[
                        ...
                        const Text("Additional Information", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16, color: Color(0xFF3285E1))),
                        const SizedBox(height: 10),
                        Table(
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton.icon(
                          ...
                          label: Text(isExpanded ? "Collapse" : "Extend", style: const TextStyle(color: Colors.white)),
                        ),
                      ),
                    ],
                  ),
