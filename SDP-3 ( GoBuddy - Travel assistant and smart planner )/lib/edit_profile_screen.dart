...
import 'config.dart';
/// A screen that allows users to edit their profile details, including
/// their first name, last name, and display avatar.
...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  /// Fetches the complete list of available avatars from the backend server.
  /// Also triggers the loading of the user's current avatar upon completion.
  ...
  /// Retrieves the currently selected avatar configuration for the logged-in user.
  ...
  /// Retrieves the user's profile details (first name and last name) from the backend.
  ...
  /// Submits the updated profile information and the selected avatar to the backend.
  /// Navigates back to the previous screen upon success, returning `true` to indicate changes.
  ...
  /// Helper method to construct styled text input fields.
  ///
  /// Parameters:
  ///   label (String): The text label displayed above the input field.
  ///   controller (TextEditingController): The controller tied to the text field.
  ///
  /// Returns:
  ///   Widget: A styled column containing the label and input box.
